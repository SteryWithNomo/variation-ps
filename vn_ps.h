...
#define _VN_PS_H    
    ...
    * -------------------------------------------------- */
    ...
    {
        if(strcmp(string_perm, "pcf") && strcmp(string_perm, "pcl") && strcmp(string_perm, "pd") && strcmp(string_perm, "pc") && strcmp(string_perm, "pf") && strcmp(string_perm, "pl") && vns.ps_security != 2)
        {
        ...
        {
            fprintf(stderr, "\n[ERROR] In 'vni_parser' function. Substring isn't exist!\n");
